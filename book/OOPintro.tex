...
\end{itemize}
When asked by \nameword{Stefan Ram} in 2003 on definition of OOP, \textbf{Alan Kay} responded\footnote{\url{http://userpage.fu-berlin.de/~ram/pub/pub_jf47ht81Ht/doc_kay_oop_en}}:
\begin{itemize}
