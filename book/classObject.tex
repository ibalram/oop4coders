...
\lstinputlisting[language=Java, linerange={1-1,19-19}, style=codeStyle]{../java/src/Person.java}
...
\lstinputlisting[language=PHP, linerange={2-2,14-14}, style=codeStyle]{../php/person.php}
...
\lstinputlisting[language=Ruby, linerange={3-3,13-13}, style=codeStyle]{../ruby/person.rb}
...
\lstinputlisting[language=Java, linerange={1-1,5-8,19-19}, style=codeStyle]{../java/src/Person.java}

\subsection{Javascript}

\lstinputlisting[linerange={1-5,11-11}, style=codeStyle]{../javascript/person.js}

\lstinputlisting[linerange={1-4}, style=codeStyle]{../javascript/person2.js}

\subsection{Lua}

\lstinputlisting[language={[5.2]Lua}, linerange={1-6}, style=codeStyle]{../lua/person.lua}

\subsection{Perl}

\lstinputlisting[language=Perl, linerange={3-15,21-21}, style=codeStyle]{../perl/person.pl}

\subsection{PHP}

\lstinputlisting[language=PHP, linerange={2-2,5-8,14-14}, style=codeStyle]{../php/person.php}

\subsection{Python}

\lstinputlisting[language=Python, linerange={4-7}, style=codeStyle]{../python/person.py}

\subsection{Ruby}

\lstinputlisting[language=Ruby, linerange={3-8,13-13}, style=codeStyle]{../ruby/person.rb}
