...
\lstinputlisting[style=codeStyle]{../codes/javascript/obj_meth.js}
...
\lstinputlisting[language={[5.2]Lua}, linerange={8-10}, style=codeStyle]{../codes/lua/objmeth.lua}
...
\lstinputlisting[language={[5.2]Lua}, linerange={12-14}, style=codeStyle]{../codes/lua/objmeth.lua}
...
\lstinputlisting[language={[5.2]Lua}, linerange={16-22}, style=codeStyle]{../codes/lua/objmeth.lua}

To call them:

\lstinputlisting[language={[5.2]Lua}, linerange={28-32}, style=codeStyle]{../codes/lua/objmeth.lua}
...
\lstinputlisting[language=Perl, linerange={16-20}, style=codeStyle]{../codes/perl/objmeth.pl}
...
\lstinputlisting[language=Perl, linerange={16-16,21-24}, style=codeStyle]{../codes/perl/objmeth.pl}
...
\lstinputlisting[language=PHP, linerange={2-2,12-14,20-20}, style=codeStyle]{../codes/php/objmeth.php}
...
\lstinputlisting[language=PHP, linerange={2-2,16-20}, style=codeStyle]{../codes/php/objmeth.php}
...
\lstinputlisting[language=PHP, linerange={22-22,26-26,29-30}, style=codeStyle]{../codes/php/objmeth.php}
...
\lstinputlisting[language=Python, linerange={4-4,10-11}, style=codeStyle]{../codes/python/objmeth.py}

Then, you can use it by calling the method \keyword{str}

\lstinputlisting[language=Python, linerange={27-27,29-29}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language=Python, linerange={27-27,32-32}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language=Python, linerange={4-4,13-14}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language=Python, linerange={4-4, 16-17, 27-27, 32-32, 34-34}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language=Python, linerange={4-4, 19-20, 27-27, 32-32, 36-36}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language=Python, linerange={4-4, 22-23, 27-27, 30-30}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language=Ruby, linerange={3-3,18-20,39-41,44-44}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language=Ruby, linerange={3-3,12-16,39-41,47-47}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language=Ruby, linerange={3-3,31-33,39-41,47-47,49-49}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language=Ruby, linerange={3-4,22-29,39-42,47-47,50-52}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language=Ruby, linerange={3-3,35-41,45-45}, style=codeStyle]{../codes/ruby/objmeth.rb}
