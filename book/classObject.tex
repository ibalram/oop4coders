...
\lstinputlisting[language={[KB]C++}, linerange={4-5,34-34}, style=codeStyle]{../codes/cpp/person0.cpp}

\subsection{Java}

\lstinputlisting[language={[KB]Java}, linerange={1-1,40-40}, style=codeStyle]{../codes/java/src/Person.java}

\subsection{Javascript}

There are no classes in javascript, a function can be used to simulate a class. 

\lstinputlisting[language={[KB]Javascript}, linerange={1-1,5-5}, style=codeStyle]{../codes/javascript/person2.js}
...
\lstinputlisting[language={[KB]Javascript}, linerange={1-1,15-15}, style=codeStyle]{../codes/javascript/person.js}
...
\lstinputlisting[language={[KB]C++}, linerange={4-19,34-34}, style=codeStyle]{../codes/cpp/person0.cpp}
...
\lstinputlisting[language={[KB]C++}, linerange={40-41}, style=codeStyle]{../codes/cpp/person0.cpp}
...
\lstinputlisting[language={[KB]C++}, linerange={48-48}, style=codeStyle]{../codes/cpp/person0.cpp}
...
\lstinputlisting[language={[KB]Java}, linerange={1-1,5-17,40-40}, style=codeStyle]{../codes/java/src/Person.java}

To create a new object, use the keyword \keyword{new}.

\lstinputlisting[language={[KB]Java}, linerange={28-28}, style=codeStyle]{../codes/java/src/Person.java}

To fasten the destruction of an object, you can assign \keyword{null} to all variables referencing it.

\lstinputlisting[language={[KB]Java}, linerange={36-36}, style=codeStyle]{../codes/java/src/Person.java}
...
\lstinputlisting[language={[KB]Javascript}, linerange={1-6,15-15}, style=codeStyle]{../codes/javascript/person.js}

Actually, a function can be used to define a prototype (class) and it is in the same time a constructor.

\lstinputlisting[language={[KB]Javascript}, linerange={1-5}, style=codeStyle]{../codes/javascript/person2.js}

To create a new object, you use the keyword \keyword{new}

\lstinputlisting[language={[KB]Javascript}, linerange={19-19}, style=codeStyle]{../codes/javascript/person.js}
...
\lstinputlisting[language={[KB]Lua}, linerange={4-7}, style=codeStyle]{../codes/lua/person.lua}

Then to create a new object, we simply call that function.

\lstinputlisting[language={[KB]Lua}, linerange={19-19}, style=codeStyle]{../codes/lua/person.lua}
...
\lstinputlisting[language={[KB]Lua}, linerange={4-9}, style=codeStyle]{../codes/lua/person2.lua}

Then, we create a new object as follows

\lstinputlisting[language={[KB]Lua}, linerange={21-21}, style=codeStyle]{../codes/lua/person2.lua}
...
\lstinputlisting[language={[KB]Perl}, linerange={3-23,34-34}, style=codeStyle]{../codes/perl/person.pl}
...
\lstinputlisting[language={[KB]Perl}, linerange={36-37}, style=codeStyle]{../codes/perl/person.pl}

To delete a reference, you use \keyword{undef} which will trigger the destructor.

\lstinputlisting[language={[KB]Perl}, linerange={44-44}, style=codeStyle]{../codes/perl/person.pl}

\subsection{PHP}

The constructor is a function called \keyword{\_\_construct} and the destructor is a function called \keyword{\_\_destruct}.

\lstinputlisting[language={[KB]PHP}, linerange={2-2,8-17,27-27}, style=codeStyle]{../codes/php/person.php}

To create an instance of the class, the keyword \keyword{new} is used.

\lstinputlisting[language={[KB]PHP}, linerange={29-29}, style=codeStyle]{../codes/php/person.php}

To delete a reference, the keyword \keyword{unset} is used.

\lstinputlisting[language={[KB]PHP}, linerange={37-37}, style=codeStyle]{../codes/php/person.php}

\subsection{Python}

The constructor is a function called \keyword{\_\_init\_\_} and the destructor is a function called \keyword{\_\_del\_\_}.

\lstinputlisting[language={[KB]Python}, linerange={4-4,8-15}, style=codeStyle]{../codes/python/person.py}

To create an object, we call the class as a function

\lstinputlisting[language={[KB]Python}, linerange={24-24}, style=codeStyle]{../codes/python/person.py}

To delete a reference, the keyword \keyword{del} is used.

\lstinputlisting[language={[KB]Python}, linerange={32-32}, style=codeStyle]{../codes/python/person.py}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-17,25-25}, style=codeStyle]{../codes/ruby/person.rb}

To create a new object from our class, we call its function \keyword{new}.

\lstinputlisting[language={[KB]Ruby}, linerange={27-27}, style=codeStyle]{../codes/ruby/person.rb}

To free a reference from an object, you can assign it the \keyword{nil} value.

\lstinputlisting[language={[KB]Ruby}, linerange={35-35}, style=codeStyle]{../codes/ruby/person.rb}
...
\lstinputlisting[language={[KB]C++}, linerange={31-33}, style=codeStyle]{../codes/cpp/person0.cpp}

Non constant class (static) fields must be initialized outside the header and not inside it. 

\lstinputlisting[language={[KB]C++}, linerange={36-36}, style=codeStyle]{../codes/cpp/person0.cpp} 
...
\lstinputlisting[language={[KB]C++}, linerange={20-27}, style=codeStyle]{../codes/cpp/person0.cpp}
...
\lstinputlisting[language={[KB]C++}, linerange={43-45}, style=codeStyle]{../codes/cpp/person0.cpp}
...
\lstinputlisting[language={[KB]Java}, linerange={2-4}, style=codeStyle]{../codes/java/src/Person.java}

Methods are defined inside the class block where static ones are distinguished by the keyword \keyword{static}.

\lstinputlisting[language={[KB]Java}, linerange={18-25}, style=codeStyle]{../codes/java/src/Person.java}

Static methods are called using the class name; But, also, they can be called from the instance. 

\lstinputlisting[language={[KB]Java}, linerange={31-33}, style=codeStyle]{../codes/java/src/Person.java}
...
\lstinputlisting[language={[KB]Javascript}, linerange={3-4}, style=codeStyle]{../codes/javascript/person.js}
...
\lstinputlisting[language={[KB]Javascript}, linerange={17-17}, style=codeStyle]{../codes/javascript/person.js}

Methods are defined inside the class definition in ES6. 
Also, static methods are preceded by the keyword \keyword{static}. 

\lstinputlisting[language={[KB]Javascript}, linerange={1-1,8-15}, style=codeStyle]{../codes/javascript/person.js}
...
\lstinputlisting[language={[KB]Javascript}, linerange={9-15}, style=codeStyle]{../codes/javascript/person2.js}

Properties can be defined using \keyword{Object.defineProperties} and the keywords \keyword{get} and \keyword{set}.

\lstinputlisting[language={[KB]Javascript}, linerange={9-11,13-14,22-25,27-35}, style=codeStyle]{../codes/javascript/property.js}
...
\lstinputlisting[language={[KB]Lua}, linerange={4-9}, style=codeStyle]{../codes/lua/person.lua}
...
\lstinputlisting[language={[KB]Lua}, linerange={11-17}, style=codeStyle]{../codes/lua/person.lua}

To call the methods, there are two ways for dynamic methods.

\lstinputlisting[language={[KB]Lua}, linerange={22-24}, style=codeStyle]{../codes/lua/person.lua}
...
\lstinputlisting[language={[KB]Lua}, linerange={1-15,22-24,33-38}, style=codeStyle]{../codes/lua/property.lua}

\subsection{Perl}

Object fields are defined in the hash which will be returned by the \keyword{new} subroutine as the new object. 

\lstinputlisting[language={[KB]Perl}, linerange={10-13}, style=codeStyle]{../codes/perl/person.pl}
...
\lstinputlisting[language={[KB]Perl}, linerange={6-6}, style=codeStyle]{../codes/perl/person.pl}
...
\lstinputlisting[language={[KB]Perl}, linerange={25-32}, style=codeStyle]{../codes/perl/person.pl}

As said, the difference between dynamic and static methods is in how they are called. 

\lstinputlisting[language={[KB]Perl}, linerange={39-41}, style=codeStyle]{../codes/perl/person.pl}
...
\lstinputlisting[language={[KB]Perl}, linerange={3-3,14-17,25-33,40-46}, style=codeStyle]{../codes/perl/property.pl}
...
\lstinputlisting[language={[KB]PHP}, linerange={2-7,27-27}, style=codeStyle]{../codes/php/person.php}
...
\lstinputlisting[language={[KB]PHP}, linerange={2-2,19-25,27-27}, style=codeStyle]{../codes/php/person.php}

The call is different between dynamic and static functions.

\lstinputlisting[language={[KB]PHP}, linerange={32-34}, style=codeStyle]{../codes/php/person.php}
...
\lstinputlisting[language={[KB]PHP}, linerange={2-2,11-12,21-37}, style=codeStyle]{../codes/php/property.php}
...
\lstinputlisting[language={[KB]Python}, linerange={4-11}, style=codeStyle]{../codes/python/person.py}
...
\lstinputlisting[language={[KB]Python}, linerange={4-4,17-22}, style=codeStyle]{../codes/python/person.py}

The dynamic methods are accessed via the instance while the static ones are accessed using the class name.

\lstinputlisting[language={[KB]Python}, linerange={27-29}, style=codeStyle]{../codes/python/person.py}
...
\lstinputlisting[language={[KB]Python}, linerange={4-4,13-14,16-18,20-22, 28-33}, style=codeStyle]{../codes/python/property.py}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-11,25-25}, style=codeStyle]{../codes/ruby/person.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-3,18-25}, style=codeStyle]{../codes/ruby/person.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={30-32}, style=codeStyle]{../codes/ruby/person.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-3,9-17,24-24,30-36}, style=codeStyle]{../codes/ruby/property.rb}
...
\lstinputlisting[language={[KB]C++}, linerange={4-5, 18-21,24-24}, style=codeStyle]{../codes/cpp/obj_meth.cpp}
...
\lstinputlisting[language={[KB]C++}, linerange={26-28}, style=codeStyle]{../codes/cpp/obj_meth.cpp}

Then, you can call it as

\lstinputlisting[language={[KB]C++}, linerange={41-41,44-44}, style=codeStyle]{../codes/cpp/obj_meth.cpp}
...
\lstinputlisting[language={[KB]C++}, linerange={30-32}, style=codeStyle]{../codes/cpp/obj_meth.cpp}
...
\lstinputlisting[language={[KB]C++}, linerange={34-37}, style=codeStyle]{../codes/cpp/obj_meth.cpp}
...
\lstinputlisting[language={[KB]Java}, linerange={24-24,34-37,63-63}, style=codeStyle]{../codes/java/src/ObjMeth.java}
...
\lstinputlisting[language={[KB]Java}, linerange={7-7}, style=codeStyle]{../codes/java/src/ObjMeth.java}
...
\lstinputlisting[language={[KB]Java}, linerange={24-24,50-54,63-63}, style=codeStyle]{../codes/java/src/ObjMeth.java}
...
\lstinputlisting[language={[KB]Java}, linerange={24-24,44-48,63-63}, style=codeStyle]{../codes/java/src/ObjMeth.java}
...
\lstinputlisting[language={[KB]Java}, linerange={14-15}, style=codeStyle]{../codes/java/src/ObjMeth.java}
...
\lstinputlisting[language={[KB]Java}, linerange={24-24,56-63}, style=codeStyle]{../codes/java/src/ObjMeth.java}


\subsubsection{Hash code}

You can override \keyword{hashCode()} method to define specialized hash code calculation to a class.
\lstinputlisting[language={[KB]Java}, linerange={39-42}, style=codeStyle]{../codes/java/src/ObjMeth.java}
...
\lstinputlisting[language={[KB]Javascript}, style=codeStyle]{../codes/javascript/obj_meth.js}
...
\lstinputlisting[language={[KB]Lua}, linerange={8-10}, style=codeStyle]{../codes/lua/objmeth.lua}
...
\lstinputlisting[language={[KB]Lua}, linerange={12-14}, style=codeStyle]{../codes/lua/objmeth.lua}
...
\lstinputlisting[language={[KB]Lua}, linerange={16-22}, style=codeStyle]{../codes/lua/objmeth.lua}

To call them:

\lstinputlisting[language={[KB]Lua}, linerange={28-32}, style=codeStyle]{../codes/lua/objmeth.lua}
...
\lstinputlisting[language={[KB]Perl}, linerange={16-20}, style=codeStyle]{../codes/perl/objmeth.pl}
...
\lstinputlisting[language={[KB]Perl}, linerange={16-16,21-24}, style=codeStyle]{../codes/perl/objmeth.pl}
...
\lstinputlisting[language={[KB]PHP}, linerange={2-2,12-14,20-20}, style=codeStyle]{../codes/php/objmeth.php}
...
\lstinputlisting[language={[KB]PHP}, linerange={2-2,16-20}, style=codeStyle]{../codes/php/objmeth.php}
...
\lstinputlisting[language={[KB]PHP}, linerange={22-22,26-26,29-30}, style=codeStyle]{../codes/php/objmeth.php}
...
\lstinputlisting[language={[KB]Python}, linerange={4-4,10-11}, style=codeStyle]{../codes/python/objmeth.py}

Then, you can use it by calling the method \keyword{str}

\lstinputlisting[language={[KB]Python}, linerange={27-27,29-29}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language={[KB]Python}, linerange={27-27,32-32}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language={[KB]Python}, linerange={4-4,13-14}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language={[KB]Python}, linerange={4-4, 16-17, 27-27, 32-32, 34-34}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language={[KB]Python}, linerange={4-4, 19-20, 27-27, 32-32, 36-36}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language={[KB]Python}, linerange={4-4, 22-23, 27-27, 30-30}, style=codeStyle]{../codes/python/objmeth.py}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-3,18-20,39-41,44-44}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-3,12-16,39-41,47-47}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-3,31-33,39-41,47-47,49-49}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-4,22-29,39-42,47-47,50-52}, style=codeStyle]{../codes/ruby/objmeth.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={3-3,35-41,45-45}, style=codeStyle]{../codes/ruby/objmeth.rb}
