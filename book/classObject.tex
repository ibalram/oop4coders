...
To define dynamic methods, there are two ways where the colon (\textbf{:}) will add \textbf{self} implicitly.
...
As for static methods, they are defined as \textit{method1} without \textbf{self} keyword.
...
Properties can be defined by using the meta-methods \textbf{\_\_index} and \textbf{\_\_newindex}.
When the interpreter can not find a field, it calls the \textbf{\_\_index} meta-method. 
It has \textbf{self} and a key as arguments, and can be used to define getters in our case. 
...
\textbf{\_\_newindex} meta-method is used for table update and can be used as a setter. 

\lstinputlisting[language={[5.2]Lua}, linerange={1-15,22-24,33-38}, style=codeStyle]{../lua/property.lua}
