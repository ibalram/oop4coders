...
\begin{landscape}
	\begin{longtabu}{llllllll}  %to \textheight {XXXXXXXX} %{llllllll} 
		\caption{Abstraction comparison}%
		\label{tab-abstraction}\\
		\hline
		\multicolumn{1}{c}{\textbf{Language}} &
		\multicolumn{1}{c}{\textbf{Style}} &
		\multicolumn{1}{c}{\textbf{Class type}} &
		\multicolumn{1}{|c|}{\textbf{Definition}} &
		\multicolumn{1}{|c|}{\textbf{Universal superclass}} &
		\multicolumn{1}{|c|}{\textbf{Dynamic members}} &
		\multicolumn{1}{|c|}{\textbf{Static members}} &
