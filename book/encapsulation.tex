...
Members visibility knows three main modes: public, protected and private. 
Some languages give full access to class members; in this case, it is the visibility can be indicated via the API's documentation. 
Also, you can define some code conventions to indicate the visibility. 
Javascript, Lua, Perl and Python are ones of those languages. 
There are languages which gives the ability to choose between these three visibility modes. 
This type of languages knows: C++, Java and PHP. 
Ruby fixes its attributes visibility to protected, and limits its methods visibility to public and protected. 

Table~\ref{tab-encapsulation} represents a comparison between OO languages based on their visibility modes:
public, protected and private. 
When you find the word \textbf{member}, it means a field's or a method's definition. 
In Perl and Lua, the object is created inside the constructor which is referred to here as \textbf{myobject}.
