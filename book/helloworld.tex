...
\lstinputlisting[language=Java, style=codeStyle]{../java/src/Entry.java}
...
\lstinputlisting[linerange={1-9}, style=codeStyle]{../javascript/entry.js}
...
\lstinputlisting[language={[5.2]Lua}, style=codeStyle]{../lua/entry.lua}
...
\lstinputlisting[language=Perl, linerange={3-7}, style=codeStyle]{../perl/entry.pl}
...
\lstinputlisting[language=PHP, linerange={4-10}, style=codeStyle]{../php/entry.php}
...
\lstinputlisting[language=Python, style=codeStyle]{../python/entry.py}
...
\lstinputlisting[language=Ruby, style=codeStyle]{../ruby/entry.rb}
...
\lstinputlisting[language=C++, linerange={4-6}, style=codeStyle]{../cpp/except.cpp}

Then, capture it

\lstinputlisting[language=C++, linerange={23-29}, style=codeStyle]{../cpp/except.cpp}
...
\lstinputlisting[language=C++, linerange={6-16}, style=codeStyle]{../cpp/except2.cpp}

The exceptions can be thrown by creating a new instance of the defined classes. 

\lstinputlisting[language=C++, linerange={19-20}, style=codeStyle]{../cpp/except2.cpp}

We catch them either by they parent's type \textbf{std::exception}, or by catching each type apart. 

\lstinputlisting[language=C++, linerange={35-41}, style=codeStyle]{../cpp/except2.cpp}
...
\lstinputlisting[language=Java, linerange={39-50}, style=codeStyle]{../java/src/Except.java}
...
\lstinputlisting[language=Java, linerange={30-32}, style=codeStyle]{../java/src/Except.java}
...
\lstinputlisting[language=Java, linerange={17-26}, style=codeStyle]{../java/src/Except.java}
...
\lstinputlisting[language=Java, linerange={4-15}, style=codeStyle]{../java/src/Except.java}

\subsection{Javascript}

Using \textbf{throw} statement, you can throw an exception of any type: integer, string, object, etc. 

\lstinputlisting[language=Java, linerange={21-23}, style=codeStyle]{../javascript/except.js}
...
\lstinputlisting[language=Java, linerange={10-19}, style=codeStyle]{../javascript/except.js}
...
\lstinputlisting[language={[5.2]Lua}, linerange={1-3}, style=codeStyle]{../lua/except.lua}
...
\lstinputlisting[language={[5.2]Lua}, linerange={14-20}, style=codeStyle]{../lua/except.lua}
...
\lstinputlisting[language=Perl, linerange={14-17}, style=codeStyle]{../perl/except.pl}

Using \textbf{eval}, you can capture the error into \textbf{\$@}.

\lstinputlisting[language=Perl, linerange={6-12}, style=codeStyle]{../perl/except.pl}
...
\lstinputlisting[language=PHP, linerange={4-14}, style=codeStyle]{../php/except.php}
...
\lstinputlisting[language=PHP, linerange={16-18}, style=codeStyle]{../php/except.php}

Then, to capture the exception, you can use \textbf{try} and \textbf{catch}.

\lstinputlisting[language=PHP, linerange={30-39}, style=codeStyle]{../php/except.php}
...
\lstinputlisting[language=Python, linerange={6-12}, style=codeStyle]{../python/except.py}

To throw an exception, use the keyword \textbf{raise}

\lstinputlisting[language=Python, linerange={14-18}, style=codeStyle]{../python/except.py}
...
\lstinputlisting[language=Python, linerange={28-32}, style=codeStyle]{../python/except.py}

There are some built-in exceptions you can use, such as this example.

\lstinputlisting[language=Python, linerange={34-38}, style=codeStyle]{../python/except.py}
...
\lstinputlisting[language=Python, linerange={1-6}, style=codeStyle]{../ruby/except.rb}
...
\lstinputlisting[language=Python, linerange={21-28}, style=codeStyle]{../ruby/except.rb}
...
\lstinputlisting[language=Python, linerange={1-12}, style=codeStyle]{../ruby/except2.rb}

To throw them, all you have to do is creating an instance after calling \textbf{raise}.

\lstinputlisting[language=Python, linerange={16-19}, style=codeStyle]{../ruby/except2.rb}

You can capture them by their parent exception class \textbf{Exception}, or each by its class.

\lstinputlisting[language=Python, linerange={37-40}, style=codeStyle]{../ruby/except2.rb}
