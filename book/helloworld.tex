...
%	\centering
%	\vspace{-20pt}
%	\includegraphics[width=2cm]{../img/Perl.pdf}
%	\vspace{-10pt}
%\end{wrapfigure}
...
\begin{wrapfigure}{l}{2.25cm}
	\centering
	\vspace{-20pt}
	\includegraphics[width=2cm]{../img/Ruby.pdf}
	\vspace{-20pt}
\end{wrapfigure}
...
The arguments passed by Node.js are stored in an array of strings \keyword[Javascript]{process.argv} which has \keyword{node} as its first elements, the name of the script as the second, and the rest are the command-line arguments.
