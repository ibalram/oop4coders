...
\lstinputlisting[language={[KB]Java}, linerange={2-2,12-17}, style=codeStyle]{../codes/java/src/hello/Func.java}
...
\lstinputlisting[language={[KB]Java}, linerange={39-50}, style=codeStyle]{../codes/java/src/hello/Except.java}
...
\lstinputlisting[language={[KB]Java}, linerange={30-32}, style=codeStyle]{../codes/java/src/hello/Except.java}
...
\lstinputlisting[language={[KB]Java}, linerange={17-26}, style=codeStyle]{../codes/java/src/hello/Except.java}
...
\lstinputlisting[language={[KB]Java}, linerange={4-15}, style=codeStyle]{../codes/java/src/hello/Except.java}
