...
\lstinputlisting[language=Ruby, linerange={1-6}, style=codeStyle]{../codes/ruby/except.rb}
...
\lstinputlisting[language=Ruby, linerange={21-30}, style=codeStyle]{../codes/ruby/except.rb}
...
\lstinputlisting[language=Ruby, linerange={1-12}, style=codeStyle]{../codes/ruby/except2.rb}

To throw them, all you have to do is creating an instance after calling \keyword{raise}.

\lstinputlisting[language=Ruby, linerange={16-19}, style=codeStyle]{../codes/ruby/except2.rb}

You can capture them by their parent exception class \keyword{Exception}, or each by its class.

\lstinputlisting[language=Ruby, linerange={37-40}, style=codeStyle]{../codes/ruby/except2.rb}
