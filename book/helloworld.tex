...
%
\lstinputlisting[language={[KB]C++}, style=codeStyle]{../codes/cpp/helloworld.cpp}
%
...
\lstinputlisting[language={[KB]Java}, style=codeStyle]{../codes/java/src/HelloWorld.java}
...
\lstinputlisting[language={[KB]Javascript}, style=codeStyle, firstline=6, lastline=9]{../codes/javascript/helloworld.htm}

It can, also, be executed using nodeJs. 

\lstinputlisting[language={[KB]Javascript}, style=codeStyle]{../codes/javascript/helloworld.js}
...
\lstinputlisting[language={[KB]Lua}, style=codeStyle]{../codes/lua/helloworld.lua}
...
\lstinputlisting[language={[KB]Perl}, style=codeStyle]{../codes/perl/helloworld.pl}
...
\lstinputlisting[language={[KB]PHP}, style=codeStyle]{../codes/php/helloworld.php}
...
\lstinputlisting[language={[KB]Python}, style=codeStyle]{../codes/python/helloworld.py}
...
\lstinputlisting[language={[KB]Ruby}, style=codeStyle]{../codes/ruby/helloworld.rb}
...
\lstinputlisting[language={[KB]C++}, linerange={12-16}, style=codeStyle]{../codes/cpp/func.cpp}
...
\lstinputlisting[language={[KB]Java}, linerange={2-2,12-17}, style=codeStyle]{../codes/java/src/Func.java}
...
\lstinputlisting[language={[KB]Javascript}, style=codeStyle]{../codes/javascript/func.js}
...
\lstinputlisting[language={[KB]Lua}, linerange={1-6}, style=codeStyle]{../codes/lua/func.lua}
...
\lstinputlisting[language={[KB]Perl}, linerange={7-13}, style=codeStyle]{../codes/perl/func.pl}
...
\lstinputlisting[language={[KB]PHP}, linerange={2-6}, style=codeStyle]{../codes/php/func.php}
...
\lstinputlisting[language={[KB]Python}, linerange={12-15}, style=codeStyle]{../codes/python/func.py}
...
\lstinputlisting[language={[KB]Ruby}, linerange={9-15}, style=codeStyle]{../codes/ruby/func.rb}
...
\lstinputlisting[language={[KB]C++}, linerange={1-17}, style=codeStyle]{../codes/cpp/entry.cpp}
...
\lstinputlisting[language={[KB]Java}, style=codeStyle]{../codes/java/src/Entry.java}
...
\lstinputlisting[language={[KB]Javascript}, linerange={1-9}, style=codeStyle]{../codes/javascript/entry.js}
...
\lstinputlisting[language={[KB]Lua}, style=codeStyle]{../codes/lua/entry.lua}
...
\lstinputlisting[language={[KB]Perl}, linerange={3-7}, style=codeStyle]{../codes/perl/entry.pl}
...
\lstinputlisting[language={[KB]PHP}, linerange={4-10}, style=codeStyle]{../codes/php/entry.php}
...
\lstinputlisting[language={[KB]Python}, style=codeStyle]{../codes/python/entry.py}
...
\lstinputlisting[language={[KB]Ruby}, style=codeStyle]{../codes/ruby/entry.rb}
...
\lstinputlisting[language={[KB]C++}, linerange={4-6}, style=codeStyle]{../codes/cpp/except.cpp}

Then, capture it

\lstinputlisting[language={[KB]C++}, linerange={23-29}, style=codeStyle]{../codes/cpp/except.cpp}
...
\lstinputlisting[language={[KB]C++}, linerange={6-16}, style=codeStyle]{../codes/cpp/except2.cpp}

The exceptions can be thrown by creating a new instance of the defined classes. 

\lstinputlisting[language={[KB]C++}, linerange={19-20}, style=codeStyle]{../codes/cpp/except2.cpp}

We catch them either by they parent's type \textbf{std::exception}, or by catching each type apart. 

\lstinputlisting[language={[KB]C++}, linerange={35-41}, style=codeStyle]{../codes/cpp/except2.cpp}
...
\lstinputlisting[language={[KB]Java}, linerange={39-50}, style=codeStyle]{../codes/java/src/Except.java}
...
\lstinputlisting[language={[KB]Java}, linerange={30-32}, style=codeStyle]{../codes/java/src/Except.java}
...
\lstinputlisting[language={[KB]Java}, linerange={17-26}, style=codeStyle]{../codes/java/src/Except.java}
...
\lstinputlisting[language={[KB]Java}, linerange={4-15}, style=codeStyle]{../codes/java/src/Except.java}

\subsection{Javascript}

Using \keyword{throw} statement, you can throw an exception of any type: integer, string, object, etc. 

\lstinputlisting[language={[KB]Javascript}, linerange={21-23}, style=codeStyle]{../codes/javascript/except.js}
...
\lstinputlisting[language={[KB]Javascript}, linerange={10-19}, style=codeStyle]{../codes/javascript/except.js}
...
\lstinputlisting[language={[KB]Lua}, linerange={1-3}, style=codeStyle]{../codes/lua/except.lua}
...
\lstinputlisting[language={[KB]Lua}, linerange={14-20}, style=codeStyle]{../codes/lua/except.lua}
...
\lstinputlisting[language={[KB]Perl}, linerange={14-17}, style=codeStyle]{../codes/perl/except.pl}

Using \keyword{eval}, you can capture the error into \keyword{\$@}.

\lstinputlisting[language={[KB]Perl}, linerange={6-12}, style=codeStyle]{../codes/perl/except.pl}
...
\lstinputlisting[language={[KB]PHP}, linerange={4-14}, style=codeStyle]{../codes/php/except.php}
...
\lstinputlisting[language={[KB]PHP}, linerange={16-18}, style=codeStyle]{../codes/php/except.php}

Then, to capture the exception, you can use \keyword{try} and \keyword{catch}.

\lstinputlisting[language={[KB]PHP}, linerange={30-39}, style=codeStyle]{../codes/php/except.php}
...
\lstinputlisting[language={[KB]Python}, linerange={6-12}, style=codeStyle]{../codes/python/except.py}

To throw an exception, use the keyword \keyword{raise}

\lstinputlisting[language={[KB]Python}, linerange={14-18}, style=codeStyle]{../codes/python/except.py}
...
\lstinputlisting[language={[KB]Python}, linerange={28-32}, style=codeStyle]{../codes/python/except.py}

There are some built-in exceptions you can use, such as this example.

\lstinputlisting[language={[KB]Python}, linerange={34-38}, style=codeStyle]{../codes/python/except.py}
...
\lstinputlisting[language={[KB]Ruby}, linerange={1-6}, style=codeStyle]{../codes/ruby/except.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={21-30}, style=codeStyle]{../codes/ruby/except.rb}
...
\lstinputlisting[language={[KB]Ruby}, linerange={1-12}, style=codeStyle]{../codes/ruby/except2.rb}

To throw them, all you have to do is creating an instance after calling \keyword{raise}.

\lstinputlisting[language={[KB]Ruby}, linerange={16-19}, style=codeStyle]{../codes/ruby/except2.rb}

You can capture them by their parent exception class \keyword{Exception}, or each by its class.

\lstinputlisting[language={[KB]Ruby}, linerange={37-40}, style=codeStyle]{../codes/ruby/except2.rb}
